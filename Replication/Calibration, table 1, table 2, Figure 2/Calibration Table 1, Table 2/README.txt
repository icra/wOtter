...
Occurences_in_river.csv is created in: Calibration, table 1, table 2, Figure 2\Create observed occurences
...
The table "results_calibration.csv" is the basis for table 1 and table 2.
